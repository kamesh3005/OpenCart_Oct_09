...
public class ExcelUtil {
	...
	public void setCellData(String sheetName, int rownum, int colnum, String data) throws IOException {
		/*
		 * File xlfile = new File(path); if (!xlfile.exists()) // If file not exists
		 * then create new file { workbook = new XSSFWorkbook(); fo = new
		 ...
		 * create new Sheet workbook.createSheet(sheetName);
		 * 
		 * sheet = workbook.getSheet(sheetName);
		 * 
